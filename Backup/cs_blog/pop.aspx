<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="pop.aspx.cs" Inherits="pop" Title="欢迎留下你的建议或意见" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="Server">
    <div id="top">
        <span></span><strong>有事你留言.有要事记着写上你的E-mail</strong></div>
    <asp:DataList ID="DataListPop" runat="server">
        <ItemTemplate>
            <div class="content">
                <div style="float: left; width: 80px">
                    <img src="images/<%# Eval("sex") %>.gif" alt="qianbao'blog" />
                </div>
    ...
    <uc1:Pagination ID="Pagination1" runat="server" />
     <h2 class="title">
               给我留言,留下你的意见和建议(给我一声祝福,送你千万个)</h2>
     <div class="formbox">
         &nbsp;
